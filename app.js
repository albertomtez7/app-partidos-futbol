...
function renderTeams() {
  ...
  okBtn.style.cssText = "display:flex;align-items:center;justify-content:center;gap:6px";
  okBtn.onclick = async () => {
  ...
  waBtn.style.cssText = "display:flex;align-items:center;justify-content:center;gap:8px";
