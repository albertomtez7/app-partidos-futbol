...
const GROUPS = {
  tejares:     { id: "tejares",     name: "Tejares",     teamSize: 5 },
  constantina: { id: "constantina", name: "Constantina", teamSize: 7 },
};
...
// ── Group selector ──────────────────────────────────────────────
document.querySelector("#btnTejares").addEventListener("click", () => selectGroup("tejares"));
document.querySelector("#btnConstantina").addEventListener("click", () => selectGroup("constantina"));
