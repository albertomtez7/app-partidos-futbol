...
// Sincronizar al volver a la app (cambio de pestaña o desbloqueo del móvil)
document.addEventListener("visibilitychange", () => {
  if (document.visibilityState === "visible") syncFromSupabase(false);
});

// Sincronizar cada 30 segundos mientras la app está abierta
setInterval(() => syncFromSupabase(false), 30000);
